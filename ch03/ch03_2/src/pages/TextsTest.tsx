...
import {Title, Subtitle, Summay, Paragraph} from "../components"

const paragraphs = D.makeArray(2).map(D.randomParagraphs).join("\n\n")
const summay = D.makeArray(3).map(D.randomSentence).join("\n")
  ...
  return (
    <div>
      ...
      <div>
        ...
        <Summay className="text-center text-gray-500">{summay}</Summay>
